...
systemMessage = SystemMessage(
    ...
    content = "Based indexed Japanese proofread rules knowledge graph, find out Japanese specific grammar pitfalls and conflicts in the content, use superscript numbers right behind the issues to point out the issues, and list the corrections with the related numbers. Explain with proofreed rules are used."
)
